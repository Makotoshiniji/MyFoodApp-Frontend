...
export default function LoginScreen({ onLoggedIn, onGoSignUp }: Props) {
  ...
  return (
    <View style={styles.root}>
      ...
      <View style={[styles.inputWrap, { marginTop: 12 }]}>
        ...
        >
          <Image source={pwdHidden ? IMAGES.hide : IMAGES.unhide} style={{ width: 22, height: 22 }} />
        </TouchableOpacity>
      </View>
...
const styles = StyleSheet.create({
  root: { flex: 1, backgroundColor: "#FFFFFF", alignItems: "center", paddingTop: 48 },
  fontMain: { fontFamily: "Montserrat-Light", color: COLOR.navy },

  welcomeTitle: { fontSize: 24, fontWeight: "800", color: COLOR.navy, marginTop: 4, marginBottom: 6, fontFamily: "Montserrat-Light" },
  subText: { color: COLOR.gray, fontSize: 14, marginBottom: 2, fontFamily: "Montserrat-Light" },
  ...
  signInBtn: {
    width: "86%", height: 50, backgroundColor: COLOR.orange,
    alignSelf: "center", borderRadius: 12, alignItems: "center", justifyContent: "center", marginTop: 20,
  },
  signInText: { color: "#fff", fontSize: 16, fontWeight: "700" },

  forgotLink: { color: COLOR.orange, marginTop: 10, fontFamily: "Montserrat-Light" },

  orRow: { width: "86%", flexDirection: "row", alignItems: "center", marginTop: 20 },
  hr: { flex: 1, height: 1, backgroundColor: "#E8EEF7" },
  orText: { marginHorizontal: 10, color: COLOR.gray, fontFamily: "Montserrat-Light" },

  mainLogo: { width: 180, height: 140, marginBottom: 10, alignSelf: "center", marginTop: 40 },

  rightEmailIcon: { position: "absolute", right: 12, width: 22, height: 22, opacity: 0.9 },

  socialBtn: {
    width: "86%", height: 52, backgroundColor: "#F2F6FF",
    borderRadius: 12, alignSelf: "center", justifyContent: "center", marginTop: 8,
  },
  socialBtnInner: {
    position: "relative", width: "100%", alignItems: "center", justifyContent: "center", flexDirection: "row",
  },
