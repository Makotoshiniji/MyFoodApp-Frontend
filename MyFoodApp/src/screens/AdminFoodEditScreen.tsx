...
//       // ---------------------------------------------------------
//       // ⭐️ Corrected Image Logic based on your File Explorer Evidence
//       // ---------------------------------------------------------
...
//           if (!path.includes('/')) {
//             if (realShopId) {
//               // 🟢 FIX: Prioritize the path structure seen in your Windows Explorer
//               // Structure: /shop_uploads/menu/{shopId}/{filename}
//               path = `/shop_uploads/menu/${realShopId}/${path}`;
//             } else {
//               // Fallback if no shopId (unlikely in edit screen)
