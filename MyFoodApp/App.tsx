...
import AdminFoodOptionEditScreen from './src/screens/AdminFoodOptionEditScreen';
import BillHistoryScreen from './src/screens/BillHistoryScreen';
import BillHistoryDetailScreen from './src/screens/BillHistoryDetailScreen';
...
export type RootStackParamList = {
  ...
  AdminFoodOptionEditScreen: { foodId: number; foodName: string };
  BillHistory: { userId: number };
  BillHistoryDetail: { orderId: number };
};
      ...
      {user ? (
        ...
        >
          ...
          <Stack.Screen
            ...
            component={BillHistoryDetailScreen}
            options={{ headerShown: false }}
          />
          ...
          />
          <Stack.Screen
            name="AdminFoodOptionEditScreen"
            component={AdminFoodOptionEditScreen}
            options={{ title: 'จัดการตัวเลือก', headerShown: true }}
          />
        </Stack.Navigator>
      ) : (
        <Stack.Navigator
